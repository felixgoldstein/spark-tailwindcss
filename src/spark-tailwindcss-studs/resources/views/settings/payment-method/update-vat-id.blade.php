<spark-update-vat-id :user="user" :team="team" :billable-type="billableType" inline-template>
    <div class="relative flex flex-col min-w-0 rounded break-words border bg-white border-1 border-grey-light card-default">
        <div class="py-3 px-6 mb-0 bg-grey-lighter border-b-1 border-grey-light text-grey-darkest">{{__('Update VAT ID')}}</div>
            ...
            <form role="form">
                ...
                <div class="mb-4 flex flex-wrap">
                    ...
                    <div class="md:w-1/2 pr-4 pl-4">
                        <input type="text" class="block appearance-none w-full py-1 px-2 mb-1 text-base leading-normal bg-white text-grey-darker border border-grey rounded" name="vat_id" v-model="form.vat_id" :class="{'bg-red-dark': form.errors.has('vat_id')}">

                        <span class="hidden mt-1 text-sm text-red" v-show="form.errors.has('vat_id')">
