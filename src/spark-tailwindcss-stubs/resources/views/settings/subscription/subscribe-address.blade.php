...
<div class="mb-4 flex flex-wrap" v-if="countryCollectsVat">
    ...
    <div class="md:w-1/2 pr-4 pl-4">
        <input type="text" class="block appearance-none w-full py-1 px-2 mb-1 text-base leading-normal bg-white text-grey-darker border border-grey rounded" v-model="form.vat_id" :class="{'bg-red-dark': form.errors.has('vat_id')}">
