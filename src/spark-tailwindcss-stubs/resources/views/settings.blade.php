    ...
    <spark-settings :user="user" :teams="teams" inline-template>
        <div class="spark-screen container mx-auto">
            <div class="flex flex-wrap">
                <!-- Tabs -->
                <div class="md:w-1/4 pr-4 pl-4 spark-settings-tabs">
                    <aside>
                        <h3 class="nav-heading ">
                            {{__('Settings')}}
                        </h3>
                        <ul class="flex flex-wrap list-reset pl-0 mb-0 flex-column mb-4 ">
                            <li class=" ">
                                <a class="inline-block py-2 px-4 no-underline" href="#profile" aria-controls="profile" role="tab" data-toggle="tab">
              ...
              18c2.7737 0 5.2177-1.4116 6.6528-3.5556C14.6268 13.517 12.3738 13 10 13s-4.627.517-6.6528 1.4444z "></path>
                            ...
                            @if (Spark::usesTeams())
                                <li class=" ">
                                    <a class="inline-block py-2 px-4 no-underline" href="#{{Spark::teamsPrefix()}}" aria-controls="teams" role="tab" data-toggle="tab">
              ...
              0-1.2-.2.8-1 1.3-2.4 1.3-3.8s0-2.7-1-3.8l1-.2z "></path>
                            ...
                            <li class=" ">
                                <a class="inline-block py-2 px-4 no-underline" href="#security" aria-controls="security" role="tab" data-toggle="tab">
              ...
              6.7V17h2v-2.3c.6-.3 1-1 1-1.7 0-1-1-2-2-2s-2 1-2 2c0 .7.4 1.4 1 1.7zM6 6v2h6V6c0-1.7-1.3-3-3-3S6 4.3 6 6z "></path>
                            ...
                            @if (Spark::usesApi())
                                <li class=" ">
                                    <a class="inline-block py-2 px-4 no-underline" href="#api" aria-controls="api" role="tab" data-toggle="tab">
                        ...
                        <aside>
                            ...
                            <ul class="flex flex-wrap list-reset pl-0 mb-0 flex-column mb-4 ">
                                @if (Spark::hasPaidPlans())
                                    <li class=" ">
                                        <a class="inline-block py-2 px-4 no-underline" href="#subscription" aria-controls="subscription" role="tab" data-toggle="tab">
              ...
              2 5 0 4-3 7-7 7v-2c2.8 0 5-2.2 5-5 0-1.4-.6-2.6-1.5-3.5L12 5zM7 20l-4-4 4-4v8zM7 8V0l4 4-4 4z"></path>
                                ...
                                <li class=" ">
                                    <a class="inline-block py-2 px-4 no-underline" href="#payment-method" aria-controls="payment-method" role="tab" data-toggle="tab">
              ...
              8h4v2H4v-2z"></path>
                                ...
                                <li class=" ">
                                    <a class="inline-block py-2 px-4 no-underline" href="#invoices" aria-controls="invoices" role="tab" data-toggle="tab">
                                        <svg class="icon-20 " xmlns="http://www.w3.org/2000/svg " viewBox="0 0 20 20 ">
